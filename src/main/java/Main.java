...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        final AverageAirportDelayForEachAirportConsumer averageAirportDelayForEachAirportConsumer = new AverageAirportDelayForEachAirportConsumer(new KafkaConsumerClient(host, clientId, groupId), dynamoDBClient);
